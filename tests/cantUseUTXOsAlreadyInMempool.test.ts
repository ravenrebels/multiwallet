    ...
    vout: [
      {
        ...
        scriptPubKey: {
          ...
          reqSigs: 1,
          type: "pubkeyhash",
          addresses: ["muFNS6FWVeeyzN1UJzbJztTCnNCQ5YPLqp"],
        },
        valueSat: 1000000000,
      },
      {
        ...
        scriptPubKey: {
          ...
          reqSigs: 1,
          type: "pubkeyhash",
          addresses: ["mq33NLStX1EWv5vvDDj18jhH9U2JBVxGBL"],
        },
        valueSat: 58000000,
      },
    ],
...
test("Verify that 39fb47ffd320e437a5168cc6fc186987ce02c189a5102960c00afbfe658a4ba6_2 is in mempool", () => {
  const exists = !!getUTXO(
    "39fb47ffd320e437a5168cc6fc186987ce02c189a5102960c00afbfe658a4ba6",
    2
  );
...
test("Verify that UTXO 67ab24f2f7f4a7b2e88c3bf212283352b251200636faa1af8468d9c9632c9c6e 2 is NOT in mempool", () => {
  const exists = !!getUTXO(
    "67ab24f2f7f4a7b2e88c3bf212283352b251200636faa1af8468d9c9632c9c6e",
    2
  );
